...
public partial class Rpt_LectureCancellation_ApprovalRejection : System.Web.UI.Page
{
    ...
    private void FillDDL_AcadYear()
    {
        try
        {
            ...
            ddlAcademicYear.Items.Insert(0, "Select AcadYear");
    ...
    private void FillDDL_Centre()
    {
        try
        {
            ...
            ddlCenters.Items.Insert(0, "Select Centers");
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        for (int cnt = 0; cnt <= ddlCenters.Items.Count - 1; cnt++)
        {
            if (ddlCenters.Items[cnt].Selected == true)
            {
                ...
                CenterName = CenterName + ddlCenters.Items[cnt].Text + ",";
            }
        }
        ...
        try
        {
            ...
            DataSet ds;
            ds = ProductController.LectureCancellation_rejection(ddldivision.SelectedValue, fromdate, todate, AcadYear, CourseCode, LmsProductCode, CenterCode);
             ...
             if (ds.Tables[0].Rows.Count > 0)
             {
                 ...
                 lblAcadYear.Text = ddlAcademicYear.SelectedItem.ToString();
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filenamexls1 = "Lecture_Cancellation RejectionApproval" + DateTime.Now + ".xls";
            ...
            HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='8'>Lecture Cancellation Rejection_Approval Report </b></TD></TR>");
            Response.Charset = "";
