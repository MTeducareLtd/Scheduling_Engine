...
public partial class Rpt_ModeOfAttendance : System.Web.UI.Page
{
        ...
        HttpCookie cookie = Request.Cookies.Get("MyCookiesLoginInfo");
         ...
         string DateRange = "";
          ...
          if (DateRange.Length != 0)
          {
              ...
              DataSet ds = ProductController.Rpt_ModeOfAttendance(ddldivision.SelectedValue,ddlAcademicYear.SelectedValue, fromdate, todate, ddlCourse.SelectedValue , Userid, 1);
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Mode_Of_Attendance" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='4'>Mode Of Attendance Report </b></TD></TR><TR style='color: #fff; background: black;text-align:center;'><TD Colspan='1'>Divison </b></TD><TD Colspan='1'>" + ddldivision.SelectedItem.ToString() + " </b></TD><TD Colspan='1'>Acad Year </b></TD><TD Colspan='1'>" + ddlAcademicYear.SelectedItem.ToString() + " </b></TD></TR><TR style='color: #fff; background: black;text-align:center;'><TD Colspan='1'>Period </b></TD><TD Colspan='1'>" + lblPeriod_Result.Text + " </b></TD><TD Colspan='1'></b></TD><TD Colspan='1'></b></TD></TR>");
        Response.Charset = "";
