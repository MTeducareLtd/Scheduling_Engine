<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTimeTable.master" AutoEventWireup="true"
    CodeFile="MonthlyClosingProcedure.aspx.cs" Inherits="MonthlyClosingProcedure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Monthly Closing Procedure<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <div class="well" style="text-align: center; background-color: #F0F0F0">
                    <!--Button Area -->
                    <asp:Button class="btn btn-app btn-success  btn-mini radius-4" runat="server" ID="btnCloseLecture"
                        Text="Close Lecture" ToolTip="Close Lecture" Width="105px" />
