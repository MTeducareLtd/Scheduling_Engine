<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTimeTable.master" AutoEventWireup="true"
    CodeFile="AssignStudentstoBatches.aspx.cs" Inherits="AssignStudentstoBatches" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Assign Students to Batches<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox runat="server" ID="txtBatchName" ToolTip="Batch Name" type="text" Width="130px"
                                                                    MaxLength="50" />
