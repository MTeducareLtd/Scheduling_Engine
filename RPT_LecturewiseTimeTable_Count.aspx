<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTimeTable.Master" AutoEventWireup="true" CodeFile="RPT_LecturewiseTimeTable_Count.aspx.cs" Inherits="RPT_LecturewiseTimeTable_Count" %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlLectStatus" Width="215px" data-placeholder="Select Lecture Status"
                                                                    ...
                                                                    <asp:ListItem Value="2">Available Lectures</asp:ListItem>
                                                                    <asp:ListItem Value="3">Pending Cancellation</asp:ListItem>
                                                                    <asp:ListItem Value="4">Cancelled Lectures</asp:ListItem>
                                                                    <asp:ListItem Value="5">Replaced Lectures</asp:ListItem>
                                                                    <asp:ListItem Value="6">Delete Lectures</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
