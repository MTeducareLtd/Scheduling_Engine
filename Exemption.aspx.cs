...
public partial class Exemption : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        if (ddlExempted.SelectedIndex==0)
        { 
            Show_Error_Success_Box("E", "Kindly Select Exemption Details");
            return;
        ...
        {
         DataSet dsGrid = ProductController.GetStudentBy_Division_Year_Standard_Centre(DivisionCode, streamcode, ddlCentre.SelectedValue, ddlProduct.SelectedValue,ddlExempted.SelectedValue,DDLSubject.SelectedValue, "1");
         if (dsGrid.Tables[0].Rows.Count > 0)
         {
             ...
             Lblexemption_Result.Text = ddlExempted.SelectedItem.ToString();
        ...
        {
            DataSet dsGrid = ProductController.GetStudentBy_Division_Year_Standard_Centre(DivisionCode, streamcode, ddlCentre.SelectedValue, ddlProduct.SelectedValue, "", DDLSubject.SelectedValue, "2");
           if (dsGrid.Tables[0].Rows.Count > 0)
           {
               dlGridDisplay.DataSource = dsGrid;
               dlGridDisplay.DataBind();
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        string exemptedfor = null;
        exemptedfor = ddlExempted.SelectedValue;
        ...
        foreach (DataListItem TextBox in dlGridDisplay.Items)
        {
            ...
            if (chkitemck.Checked == true)
            {
                ...
                //string ddlISActive = null;
                if (ddlISActive.SelectedIndex == 0)
                {
                    Show_Error_Success_Box("E", "Kindly Select IS-Exempt Status");
                    return;
                }
                ...
                ResultId = ProductController.Insert_Rollnumber(DivisionCode, Acadyear, StandardCode, Productcode, Lblcentercode.Text.Trim(), LBlsbnetry.Text.Trim(), lblSPID.Text.Trim(), exemptedfor, ddlISActive.SelectedValue, CreatedBy,Subjectcode, "2");
                if (ResultId == 1)
                {
                ...
                if (ResultId == -1)
                {
                    ...
                    lblResult.Text = "Error : Student Alredy Exeampted";
                }
