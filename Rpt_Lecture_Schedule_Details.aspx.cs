...
public partial class Rpt_Lecture_Schedule_Details : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        ControlVisibility("Search");
              ...
              DataSet ds = ProductController.GetLectureSchedule(ddldivision.SelectedValue, CenterCode, "", fromdate, todate);
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='14'>Lecture Details Report </b></TD></TR>");
        Response.Charset = "";
