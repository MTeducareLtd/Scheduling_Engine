<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTimeTable.Master" AutoEventWireup="true"
    CodeFile="Rpt_Lecture_Deviation.aspx.cs" Inherits="Rpt_Lecture_Deviation" %>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:Label ID="lblAcademicYear" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AcademicYear")%>' />
                                                </td>
                                                <td style="text-align: left;">
                                                ...
                                                <td style="text-align: right;">
                                                    <asp:Label ID="lblLectureDate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LectureDate")%>' />
                                                </td>
                                                <td style="text-align: left;">
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:Label ID="lblTeacherName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TeacherName")%>' />
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:Label ID="lblLessonPlan" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LessonPlan")%>' />
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:Label ID="lblScheduledTiming" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ScheduledTiming")%>' />
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:Label ID="lblActualTiming" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ActualTiming")%>' />
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:Label ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AttendanceClosureRemark")%>' />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
