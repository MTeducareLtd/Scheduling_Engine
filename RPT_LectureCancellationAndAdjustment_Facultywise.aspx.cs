...
public partial class RPT_LectureCancellationAndAdjustment_Facultywise : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        string division_code = "",Acad_year="",course="",CourseName="";
        ...
        foreach (ListItem li in ddlCourse.Items)
        {
            if (li.Selected == true)
            {
                listCourse.Add(li.Value);
                course = string.Join(",", listCourse.ToArray());
                listCourseName.Add(li.Text);
                CourseName = string.Join(",", listCourseName.ToArray());
            }
        }
       ...
       // course = ddlCourse.SelectedValue.ToString().Trim();
        ...
        //    centerscode = centers;
        //}
        DataSet ds = ProductController.GetLectureCancellation_Adjustment_RPT(division_code, centerscode, Acad_year, course, FromDate, ToDate, UserId);
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Lecture Cancellation and Adjustment Report - Facultywise_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center; font-size:15.0pt; text-align:center;'><TD Colspan='7'>MAHESH TUTORIALS</b></TD></TR><TR><TD Colspan='7'>Lecture Cancellation and Adjustment Report - Facultywise</TD></TR><TR><TD><span style='font-weight:bold'>Division:-</span></TD><TD>" + lblDivision_Result.Text + "</TD><TD><span style='font-weight:bold'>Acad Year:-</span></TD><TD>" + lblAcademicYear_Result.Text + "</TD><TD><span style='font-weight:bold'>Course:-</span></TD><TD Colspan='2'>" + lblCourse_Result.Text + "</TD></TR><TR><TD><span style='font-weight:bold'>Center:-</span></TD><TD Colspan='3'>" + lblCenter_Result.Text + "</TD><TD><span style='font-weight:bold'>Period:-</span></TD><TD Colspan='2'>" + lblPeriod_Result.Text + "</TD></TR><TR><TD Colspan='7'></TD></TR>");
        Response.Charset = "";
