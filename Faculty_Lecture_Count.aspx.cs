...
public partial class Faculty_Lecture_Count : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        ...
        DataSet dsGrid = null;
        dsGrid = ProductController.GEtFaculty_Lecture_Count(DivisionCode, AcademicYear, CourseCode, CenterCode, FromDate, ToDate, Batch_Code);
        //Session["SLOT"] = null;
        if (dsGrid != null)
        {
            if (dsGrid.Tables.Count != 0)
