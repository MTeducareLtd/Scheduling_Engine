...
public partial class ICB_Lecture_Entry : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        //string IsActive = "";
        //string DateRange = "";
        //DateRange = txtLectureDate.Value;
        ...
        resultid = ProductController.Insert_ICBLectureDetails(ddlDivision.SelectedValue.ToString().Trim(), ddlAcademicYear.SelectedValue.ToString().Trim(), ddlCourse.SelectedValue.ToString().Trim(), ddlCenter.SelectedValue.ToString().Trim(), ddlSubjectName.SelectedValue.ToString().Trim(), ddlLMSProduct.SelectedValue.ToString().Trim(), ddlFacultyName.SelectedValue.ToString().Trim(), "","", FromTime, ToTime, txtLectureDate.Value, UserID, 1);
        if (resultid == "-1")
        {
            Msg_Error.Visible = true;
            Msg_Success.Visible = false;
    ...
    private void FillGrid()
    {
        ...
        dsGrid = ProductController.GetICBLectureDetails(ddlDivision.SelectedValue.ToString().Trim(), ddlAcademicYear.SelectedValue.ToString().Trim(), ddlCourse.SelectedValue.ToString().Trim(), ddlLMSProduct.SelectedValue.ToString().Trim(), ddlSubjectName.SelectedValue.ToString().Trim(), ddlCenter.SelectedValue.ToString().Trim(), "", 2);
    ...
    protected void dllecture_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "comCancel")
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openModalCancel();", true);
    ...
    private void FillLectureDetails(string PKey)
    {
        ...
        {
            DataSet dsGrid = new DataSet();
            dsGrid = ProductController.Get_ICBLectureDetails_ED(PKey.Trim(), 4);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='4'>Additional Lecture</b></TD></TR><TR><TD><b>Division : " + ddlDivision.SelectedItem.ToString() + "</b></TD><TD><b>Academic Year : " + ddlAcademicYear.SelectedItem.ToString() + "</b></TD><TD Colspan='2'><b>Course : " + ddlCourse.SelectedItem.ToString() + "</b></TD></TR><TR><TD Colspan='2'><b>LMS/Non LMS Product : " + ddlLMSProduct.SelectedItem.ToString() + "</b></TD><TD><b>Subject : " + ddlSubjectName.SelectedItem.ToString() + "</b></TD><TD><b>Center : " + ddlCenter.SelectedItem.ToString() + "</b></TD></TR><TR></TR>");
        Response.Charset = "";
    ...
    {
        ddlFacultyName.Items.Clear();
        DataSet DsFaculty = ProductController.GetFacultyBy_DivisionStandardSubjectCenter(ddlDivision.SelectedValue.ToString().Trim(), ddlAcademicYear.SelectedValue.ToString().Trim(), ddlSubjectName.SelectedValue.ToString().Trim(), ddlCenter.SelectedValue.ToString().Trim(), ddlLMSProduct.SelectedValue.ToString().Trim(),"");
        BindDDL(ddlFacultyName, DsFaculty, "Partner_Name", "partner_code");
        ddlFacultyName.Items.Insert(0, "Select");
        ddlFacultyName.SelectedIndex = 0;
    }
    protected void BtnSaveEdit_Click(object sender, EventArgs e)
    {
        ...
        resultid = ProductController.Update_ICBLectureDetails(lblPkey.Text.Trim(), FromTime, ToTime, txtLectureDate.Value, 0, UserID, 5);
        if (resultid == "1")
        {
            Msg_Error.Visible = false;
            Msg_Success.Visible = true;
    ...
    protected void btnDelete_Yes_Click(object sender, EventArgs e)
    {
        ...
        string UserID = cookie.Values["UserID"];
        string UserName = cookie.Values["UserName"];
        resultid = ProductController.Update_ICBLectureDetails(lblPkey.Text.Trim(), "", "", "", 1, UserID, 3);
        if (resultid == "1")
        {
            Msg_Error.Visible = false;
            Msg_Success.Visible = true;
            UpdatePanelMsgBox.Update();
            FillGrid();
            lblSuccess.Text = "Lecture Cancelled Successfully!!";
            return;
        }
