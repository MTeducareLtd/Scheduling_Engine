<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTimeTable.Master" AutoEventWireup="true"
    CodeFile="RPT_LectureCancellationAndAdjustment_Branchwise.aspx.cs" Inherits="RPT_LectureCancellationAndAdjustment_Branchwise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Lecture Cancellation & Adjustment BranchWise - Consice<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                            ...
                                            <tr>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label44" runat="server" CssClass="red">Academic Year</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label45" runat="server" CssClass="red">Course</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="True" CssClass="chzn-select"
                                                                    data-placeholder="Select Course" Width="215px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label46" runat="server" CssClass="red">Center</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:ListBox ID="ddlCenters" runat="server" CssClass="chzn-select" data-placeholder="Select Center(s)"
                                                                    SelectionMode="Multiple" ToolTip="Center(s)" Width="215px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                    ...
                                    <ItemTemplate>
                                        <tr class="odd gradeX">
                                            ...
                                            <td style="text-align: right;">
                                                <asp:Label ID="lblLect_Adjustment" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Lect_Adjustment")%>' />
                                            </td>
                                            <td style="text-align: right;">
                                                <asp:Label ID="lblLect_Cancellation" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Lect_Cancellation")%>' />
                                            </td>
                                            <td style="text-align: right;">
                                                <asp:Label ID="lblSOS_Lect_Adjustment" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"SOS_Lect_Adjustment")%>' />
                                            </td>
                                            <td style="text-align: right;">
                                                <asp:Label ID="lblSOS_Lect_Cancellation" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"SOS_Lect_Cancellation")%>' />
                                            </td>
                                            <td style="text-align: right;">
