...
public partial class Rpt_Lecture_Cancellation_Adjustment : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        ControlVisibility("Search");
              ...
              DataSet ds = ProductController.GetLectureCancellationAdjustment(ddldivision.SelectedValue, CenterCode, fromdate, todate);
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Lecture_Cancellation_Adjustment_Rpt_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='10'>Lecture Cancellation & Adjustment Report</b></TD></TR><TR style='text-align:center;'><TD Colspan='10'><b>Division : " + ddldivision.SelectedItem.ToString() + "</b></TD></TR><TR></TR>");
        Response.Charset = "";
