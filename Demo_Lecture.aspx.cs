...
public partial class Demo_Lecture : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        resultid = ProductController.Insert_DemoLectureDetails(ddlDivision.SelectedValue.ToString().Trim(), ddlAcademicYear.SelectedValue.ToString().Trim(), ddlCourse.SelectedValue.ToString().Trim(), ddlCenter.SelectedValue.ToString().Trim(), ddlSubjectName.SelectedValue.ToString().Trim(), ddlLMSProduct.SelectedValue.ToString().Trim(), ddlFacultyName.SelectedValue.ToString().Trim(), ddlChapterName.SelectedValue.ToString().Trim(), ddlBatch.SelectedValue.ToString().Trim(), FromTime, ToTime, txtLectureDate.Value, UserID, 1);
        if (resultid == "-1")
        {
            Msg_Error.Visible = true;
            Msg_Success.Visible = false;
    ...
    private void FillGrid()
    {
        ...
        dsGrid = ProductController.GetDemoLectureDetails(ddlDivision.SelectedValue.ToString().Trim(), ddlAcademicYear.SelectedValue.ToString().Trim(), ddlCourse.SelectedValue.ToString().Trim(), ddlLMSProduct.SelectedValue.ToString().Trim(), ddlSubjectName.SelectedValue.ToString().Trim(), ddlCenter.SelectedValue.ToString().Trim(), ddlBatch.SelectedValue.ToString().Trim(), 2);
    ...
    private void FillLectureDetails(string PKey)
    {
        ...
        {
            DataSet dsGrid = new DataSet();
            dsGrid = ProductController.Get_DemoLectureDetails_ED(PKey.Trim(), 4);
    ...
    protected void BtnSaveEdit_Click(object sender, EventArgs e)
    {
        ...
        resultid = ProductController.Update_DemoLectureDetails(lblPkey.Text.Trim(), FromTime, ToTime, txtLectureDate.Value, 0, UserID, 5);
        if (resultid == "1")
        {
            Msg_Error.Visible = false;
            Msg_Success.Visible = true;
    ...
    protected void btnDelete_Yes_Click(object sender, EventArgs e)
    {
        ...
        string UserID = cookie.Values["UserID"];
        string UserName = cookie.Values["UserName"];
        resultid = ProductController.Update_DemoLectureDetails(lblPkey.Text.Trim(), "", "", "", 1, UserID, 3);
        if (resultid == "1")
        {
            Msg_Error.Visible = false;
            Msg_Success.Visible = true;
